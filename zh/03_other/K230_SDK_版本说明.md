...
本文档主要介绍了K230 SDK V1.9.0 版本发布相关的内容，包括当前版本支持的硬件、功能、使用限制等。
...
| 33 | K230 SDK V1.9 | lvgl | RTT增加LVGL                                                                  |  |
| 34 | K230 SDK V1.9 | sensor | 增加by3238的支持                                                                  |  |
...
| 50 | K230 SDK V1.9 | 驱动 | 增加Timer和GPIO用户态中断                                                                  |  |
| 51 | K230 SDK V1.9 | 开发板 | 增加庐山派板子的支持                                                                  |  |
