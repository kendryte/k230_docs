...
使用size工具可以查看内核镜像的text、data、bss等大小，vmlinux所在位置为
`k230_sdk/output/k230_evb_defconfig/little/linux`
进入该目录使用size工具查看vmlinux
...
使用size工具可以查看rt-smart镜像的text、data、bss等大小，rtthread.elf所在位置为
`k230_sdk/output/k230_evb_defconfig/big/rt-smart$`
